...
**Tests**: The examples below include test tasks. Per constitution Principle XI, tests are
...
### Tests for User Story 1 (required for business-critical logic — constitution XI) ⚠️
...
### Tests for User Story 2 (required for business-critical logic — constitution XI) ⚠️
...
### Tests for User Story 3 (required for business-critical logic — constitution XI) ⚠️
