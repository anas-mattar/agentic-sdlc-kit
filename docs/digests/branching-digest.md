...
- WIP limit: one active feature each; pipelining allows at most one awaiting-review + one active, territory disjoint. (`docs/sdlc/team-workflow.md`)
...
- Rebase on current main before the certifying gate — the gate certifies the phase as it will land. (`docs/sdlc/team-workflow.md`)
